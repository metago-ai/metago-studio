...
export default function App() {
  ...
  return (
    <div className="h-screen flex flex-col bg-atmosphere overflow-hidden">
      <Header
        onPreview={() => openPreview('kit-config.json')}
        onGenerate={() => openPreview('package.json')}
        selectedCount={selectedSkills.length}
      />

      <main className="flex-1 flex flex-col lg:flex-row gap-3 p-3 lg:p-4 overflow-y-auto lg:overflow-hidden min-h-0">
